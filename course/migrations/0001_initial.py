...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ScheduleType',
            fields=[
                ('sched_type_code', models.CharField(max_length=255, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='School',
            fields=[
                ('school_code', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visible', models.BooleanField(default=True)),
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='course.school')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term', models.CharField(choices=[('10', 'Spring'), ('20', 'Summer'), ('30', 'Fall')], max_length=2)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('primary_crosslist', models.CharField(blank=True, default='', max_length=20)),
                ('requested', models.BooleanField(default=False)),
                ('requested_override', models.BooleanField(default=False)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('year', models.CharField(max_length=4)),
                ('crosslisted', models.ManyToManyField(blank=True, default=None, to='course.Course')),
                ('instructors', models.ManyToManyField(blank=True, related_name='courses', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_at', to=settings.AUTH_USER_MODEL)),
                ('primary_subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.subject')),
                ('schedule_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='course.scheduletype')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='course.school')),
                ('sections', models.ManyToManyField(blank=True, default=None, to='course.Course')),
        ...
        migrations.CreateModel(
            name='CanvasCourse',
            fields=[
                ('canvas_id', models.IntegerField(default=None, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('TA', 'TA'), ('INST', 'Instructor'), ('DES', 'Designer'), ('LIB', 'Librarian'), ('OBS', 'Observer')], max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lps_online', models.BooleanField(default=False, verbose_name='LPS Online')),
                ...
                ('canvas_instance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='canvas', to='course.canvascourse')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tied_course', to='course.request'),
        ),
        migrations.AddField(
            model_name='course',
            name='multisection_request',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='additional_sections', to='course.request'),
        ),
        migrations.AddField(
            model_name='canvascourse',
            name='request',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='course.request'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('course_request', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='additional_enrollments', to='course.request')),
            ],
        ),
        migrations.CreateModel(
            name='RequestSummary',
